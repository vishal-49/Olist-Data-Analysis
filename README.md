<div align="center">
  ...
  <p>
    ...
    <a href="https://www.postgresql.org/"><img src="https://img.shields.io/badge/SQL-PostgreSQL-4169E1?style=for-the-badge&logo=postgresql&logoColor=white" alt="PostgreSQL" /></a>
    ...
    <img src="https://img.shields.io/badge/Last_Updated-July_2026-blue.svg?style=for-the-badge" alt="Last Updated" />
  </p>
...
| ⚙️ **Feature Engineering** | Custom calculation of logistical metrics (delivery delay days, lead times), RFM customer scoring, ABC category Pareto classifications, and order review score mapping. |
...
| 🗄️ **SQL Analytics** | Comprehensive suite of PostgreSQL production queries utilizing window functions, Common Table Expressions (CTEs), complex multi-table JOINs, and analytical aggregations. |
| 🖥️ **Power BI Dashboard** | Interactive executive dashboard built in Power BI Desktop featuring custom DAX measures, dynamic slicers, drill-through pages, and executive visual hierarchy. |
...
| :--- | :--- |
| <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/python/python-original.svg" width="20"/> **Python** | Core programming language for data extraction, automated ETL pipelines, statistical modeling, and PDF report compilation. |
| <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/pandas/pandas-original.svg" width="20"/> **Pandas** | High-performance data manipulation, dataset merging, feature transformation, and time-series aggregation. |
| <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/numpy/numpy-original.svg" width="20"/> **NumPy** | Numerical computations, vectorized matrix operations, and conditional feature modeling. |
| <img src="https://matplotlib.org/stable/_static/logo2.svg" width="20"/> **Matplotlib** | Baseline exploratory data visualization and customized static chart rendering. |
| <img src="https://images.plot.ly/logo/new-branding/plotly-logomark.png" width="20"/> **Plotly** | Interactive visual profiling, distribution plots, and dynamic diagnostic charts. |
| <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/postgresql/postgresql-original.svg" width="20"/> **PostgreSQL** | Relational database schema design, analytical querying, window functions, and business metric validation. |
| <img src="https://raw.githubusercontent.com/microsoft/PowerBI-Icons/main/SVG/Power-BI.svg" width="20"/> **Power BI** | Enterprise business intelligence, DAX measure development, interactive data modeling, and executive KPI dashboards. |
| <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/git/git-original.svg" width="20"/> **Git** | Version control, codebase management, and structured release tracking. |
...
![Sales Analytics Dashboard](assets/dashboard/sales_dashboard.png)
...
![Customer Dashboard](assets/dashboard/customer_dashboard.png)
...
![Seller Dashboard](assets/dashboard/seller_dashboard.png)
...
![Delivery Dashboard](assets/dashboard/delivery_dashboard.png)
...
![Reviews Dashboard](assets/dashboard/reviews_dashboard.png)
...
## 🗄️ Production SQL Analytics Engine
...
- [x] ⚙️ **Feature Engineered Dataset**: Enriched master table featuring RFM scores, ABC Pareto, and delivery latency metrics.
- [x] 🗄️ **SQL Analytics Scripts**: Modular PostgreSQL scripts (`sql/01_to_08_queries.sql`) covering window functions & CTEs.
...
- [x] 🖥️ **Interactive Power BI Dashboard**: Multi-page `.pbix` report with custom DAX calculations.
...
> [▶️ Watch Dashboard Video Demo (Placeholder Link)](https://github.com/your-username/Olist-Data-Analysis)

---

## 🔮 Future Improvements & Roadmap

Future iterations of this portfolio project will incorporate advanced data engineering and machine learning workflows:

- [ ] 🤖 **Machine Learning Sales Forecasting**: Implement ARIMA / Prophet models to forecast monthly GMV velocity and category-level demand.
- [ ] 📉 **Customer Churn Prediction**: Build classification models (XGBoost / LightGBM) predicting buyer churn risk based on delivery delays and star ratings.
- [ ] 🛍️ **Recommendation System**: Construct a Market Basket Analysis (Apriori algorithm) to recommend cross-sell item bundles during checkout.
- [ ] ⚡ **Real-Time Power BI Integration**: Connect Power BI to a live PostgreSQL / Snowflake cloud data warehouse.
- [ ] ☁️ **Cloud Data Deployment**: Migrate local ETL pipelines to AWS S3, AWS Glue, and Snowflake.
- [ ] 🔄 **Orchestrated ETL Pipelines**: Automate data ingestion workflows using Apache Airflow / Mage.ai.

---

## 🙏 Acknowledgements

Special thanks and appreciation to the open-source community and dataset providers that made this project possible:

- 🇧🇷 **Olist & Kaggle**: For providing the publicly accessible [Olist Brazilian E-Commerce Dataset](https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce).
- 📊 **Microsoft Power BI**: For powerful business intelligence and DAX modeling software.
- 🐍 **Python Data Science Community**: For maintaining essential libraries (`pandas`, `numpy`, `plotly`, `matplotlib`, `fpdf2`).
- 🐘 **PostgreSQL Global Development Group**: For enterprise-grade relational database management systems.

---

## 📬 Contact & Connect

I welcome questions, feedback, portfolio reviews, and technical discussions! Feel free to reach out through any of the channels below:
...
<div align="center">
  ...
  <p><em>Built with ❤️ using Python, SQL, and Power BI.</em></p>
